...
function preload() {
  trex_running = loadAnimation("mario1.png.png", "mario2.png.png", "mario3.png.png", "mario4.png.png", "mario5.png.png");// carregando a Animação do TREX correndo
  trex_collided = loadAnimation("mario.colide.png.png");// carregando a Animação do mario collide
